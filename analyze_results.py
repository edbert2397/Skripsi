...
print(f"AP: {dlog['cl_metrics']['Average Performance (AP)']}")
print(f"FT: {dlog['cl_metrics']['Forgetting (FT)']}")
print(f"BWT: {dlog['cl_metrics']['Backward Transfer (BWT)']}")
print(f"LA: {dlog['cl_metrics']['Learning Accuracy (LA)']}")

if "cl_metrics_premerge" in dlog:
    print("\nDLOG Pre-Merge Performance Matrix (base+slow+fast):")
    print(dlog["cl_metrics_premerge"]["Performance Matrix"])
    print(f"FP: {dlog['cl_metrics_premerge']['Final Performance (FP)']}")
    print(f"AP: {dlog['cl_metrics_premerge']['Average Performance (AP)']}")
    print(f"FT: {dlog['cl_metrics_premerge']['Forgetting (FT)']}")
    print(f"BWT: {dlog['cl_metrics_premerge']['Backward Transfer (BWT)']}")
    print(f"LA: {dlog['cl_metrics_premerge']['Learning Accuracy (LA)']}")
...
print(f"AP: {baseline['cl_metrics']['Average Performance (AP)']}")
print(f"FT: {baseline['cl_metrics']['Forgetting (FT)']}")
print(f"BWT: {baseline['cl_metrics']['Backward Transfer (BWT)']}")
print(f"LA: {baseline['cl_metrics']['Learning Accuracy (LA)']}")
